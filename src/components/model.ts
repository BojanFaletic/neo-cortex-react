...
// Nodes: split II and III; include IV subdivisions conceptually, single pair shown; add IT vs PT hints
const nodes: Node[] = [
  ...
  // VI: corticothalamic
  { id: 'L6_E', type: 'E', x: xLeft+120, y: Y.VI, label: 'L6 E (CT)', layer: 'VI' },
  { id: 'L6_I', type: 'I', x: xLeft+152, y: Y.VI+22, label: 'L6 I', layer: 'VI' },
  { id: 'OUT_THAL', type: 'OUT', x: xRight-20, y: Y.VI, label: '→ Thalamus (matrix/core)', layer: 'VI' },
]

const edges: Edge[] = [
  // Intralaminar microcircuits (E→E recurrence, E→I, I→E) for L2, L3, L4, L5, L6
  ...
  { id: 'L6_EE', from: 'L6_E', to: 'L6_E', kind: 'rec', width: 2 },
  { id: 'L6_EI', from: 'L6_E', to: 'L6_I', kind: 'rec', width: 2 },
  { id: 'L6_IE', from: 'L6_I', to: 'L6_E', kind: 'inh', width: 2.2 },

  // Feedforward: core thalamus -> L4; L4 -> L2/3; L2/3 -> L5; L5 -> L6; L5 -> higher cortex
  ...
  { id: 'L5_to_L6', from: 'L5_E', to: 'L6_E', kind: 'ff', width: 2.4 },
  { id: 'L5_to_UP', from: 'L5_E', to: 'OUT_UP', kind: 'ff', width: 3 },

  // Feedback: L6 -> L4 (E & I), L6 -> thalamus; L1 apical -> L2/3, L5
  { id: 'L6_to_L4E', from: 'L6_E', to: 'L4_E', kind: 'fb', width: 3 },
  { id: 'L6_to_L4I', from: 'L6_E', to: 'L4_I', kind: 'fb', width: 2.4 },
  { id: 'L6_to_THAL', from: 'L6_E', to: 'OUT_THAL', kind: 'fb', width: 2.6 },
...
const model = { nodes, edges, bands: [
  { name: 'I', y: Y.I-36 },
  { name: 'II', y: Y.II-36 }, { name: 'III', y: Y.III-36 },
  { name: 'IV', y: Y.IV-36 },
  { name: 'V', y: Y.V-36 },
  { name: 'VI', y: Y.VI-36 }
]}
